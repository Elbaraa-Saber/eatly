...
import RestaurantsBox from './ResturantsBox';
    ...
    return(
        <div className='container'>
            ...
            <div className="resturants">
                ...
                <div className='list'>
                    <RestaurantsBox img={rest1} title='The chicken King' type='Healthy' time="24min" rating='4.8'/>
                    <RestaurantsBox title='The Burger King' type='Trending' time="24min" rating='4.9'/>
                    <RestaurantsBox title='The chicken King' type='Healthy' time="24min" rating='4.8'/>
                </div>
