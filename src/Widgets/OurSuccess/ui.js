import { ListBox } from '../../Shared/UI/List/ui'
import './style.css'

export const OurSuccess = () => {
    return (
        <div className="ourSuccess">
            <div className='ourSuccess__leftIconx'>
